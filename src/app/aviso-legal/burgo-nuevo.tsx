        ...
        <div className="prose prose-gray max-w-none dark:prose-invert">
          ...
          <section className="mb-8">
            ...
            <ul className="mb-4 space-y-2">
              ...
              <li>
                ...
                INVERSIONES SL — Registro Mercantil de León, Tomo 1340, Libro 0,
                Folio 6, Sección 8ª, Hoja Registral LE25810
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              prescindibles técnicamente pero beneficiosas para el usuario. Este
              sitio web no instalará cookies prescindibles sin el consentimiento
              previo del usuario.
            </p>
            <p className="mb-4">
              El usuario tiene la posibilidad de configurar su navegador para
              ser alertado de la recepción de cookies y para impedir su
              instalación en su equipo. Por favor, consulte las instrucciones de
            ...
            <p className="mb-4">
              ...
              en foros, chats, generadores de blogs, comentarios, redes sociales
              o cualquier otro medio que permita a terceros publicar contenidos
              de forma independiente en la página web del RESPONSABLE. Sin
              embargo, y en cumplimiento de lo dispuesto en los artículos 11 y
              16 de la LSSICE, se pone a disposición de todos los usuarios,
              autoridades y fuerzas de seguridad, colaborando de forma activa en
              la retirada o, en su caso, bloqueo de todos aquellos contenidos
              que puedan afectar o contravenir la legislación nacional o
              internacional, los derechos de terceros o la moral y el orden
            ...
            <p className="mb-4">
              ...
              ordenador cuando éste se conecta a Internet. Toda esta información
              es registrada en un fichero de actividad del servidor debidamente
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              uso los Juzgados y Tribunales más cercanos a León.
            </p>
          </section>
        </div>
      </div>
